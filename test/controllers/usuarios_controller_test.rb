...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference("Usuario.count") do
      post usuarios_url, params: { usuario: { descripcion: @usuario.descripcion, tweet: @usuario.tweet } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { descripcion: @usuario.descripcion, tweet: @usuario.tweet } }
